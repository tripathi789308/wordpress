...
if (!defined('EH_STRIPE_VERSION')) {
    define('EH_STRIPE_VERSION', '3.4.7');
}
...
if(is_plugin_active('eh-stripe-payment-gateway/stripe-payment-gateway.php')){ 
    ...
    function eh_stripe_plugin_action_links($links) {
        ...
        $plugin_links = array(
            ...
            '<a href="https://www.webtoffee.com/product/woocommerce-stripe-payment-gateway/" target="_blank">' . __('Premium Upgrade', 'payment-gateway-stripe-and-woocommerce-integration') . '</a>',
            '<a href="https://www.webtoffee.com/support/" target="_blank">' . __('Support', 'payment-gateway-stripe-and-woocommerce-integration') . '</a>',
